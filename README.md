...
Project #0: Using Python to make a calculator and making a test-file to see if the calculator works.
...
Week #n: These are some optional exercises for practice in order to work on the projects.
